    ...
    (() => {
        ...
        function menuInit() {
            ...
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                ...
                } else if (!menuBody.contains(e.target)) functions_menuClose();
            }));
        }
        ...
        function initSliders() {
            ...
            if (document.querySelector(".our-services__slider")) new swiper_core_Swiper(".our-services__slider", {
            ...
            if (document.querySelector(".challenges__slider")) new swiper_core_Swiper(".challenges__slider", {
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            if (bottomMenu) {
                const links = document.querySelectorAll(".bottom-menu__link");
                links.forEach(((link, index) => {
                    const hoverClass = `hover-${index + 1}`;
                    link.addEventListener("mouseenter", (() => {
                        bottomMenu.classList.add(hoverClass);
                    }));
                    link.addEventListener("mouseleave", (() => {
                        bottomMenu.classList.remove(hoverClass);
                    }));
                }));
            }
            ...
            var pageBgMod2 = document.querySelector(".bg-mod2");
            if (pageBgMod2) document.documentElement.classList.add("bg-mod2");
        }));
        ...
        if (circle) {
            ...
            const isPointerAvailable = window.matchMedia("(hover: hover)").matches;
            if (isPointerAvailable) {
                ...
                const animateit = function(e) {
                    ...
                    const {offsetX: x, offsetY: y} = e, {offsetWidth: width, offsetHeight: height} = this, move = 25, xMove = x / width * (move * 2) - move, yMove = y / height * (move * 2) - move;
        ...
        const animLinks = document.querySelectorAll(".anim-link");
        if (animLinks) {
            const isPointerAvailableLink = window.matchMedia("(hover: hover)").matches;
            if (isPointerAvailableLink) {
                const animateit = function(e) {
                    const span = this.querySelector(".anim-wrap");
                    const {offsetX: x, offsetY: y} = e, {offsetWidth: width, offsetHeight: height} = this, move = 10, xMove = x / width * (move * 2) - move, yMove = y / height * (move * 2) - move;
                    span.style.transform = `translate(${xMove}px, ${yMove}px)`;
                    if (e.type === "mouseleave") span.style.transform = "";
                };
                animLinks.forEach((animLink => animLink.addEventListener("mousemove", animateit)));
